<script>
    ...
    module.exports = {
        ...
        ready: function (){
            let formattedId = `#${this.dropzoneId}`
            this.dropzone = new Dropzone(formattedId, {
                url: 'images/',
                method: 'POST',
            ...
            this.dropzone.options.previewTemplate = this.$el.querySelector('#preview-template').innerHTML
...
<style lang="sass">
    ...
    $uploadPreviewSize: 70px;
    .dz-preview{
        height:$uploadPreviewSize!important;
        min-height:$uploadPreviewSize!important;


        .dz-image{
            height:$uploadPreviewSize!important;
            width:$uploadPreviewSize!important;
            img{
                height:$uploadPreviewSize!important;
            }
        }
